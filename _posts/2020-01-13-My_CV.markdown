...
## Summary
Victor is a Senior Transport Analyst at Citi Logik, a transport analytics company that derives most of its insights from Mobile Network Data (MND). In his role, Victor engages in a wide range of activities such as developing new data-driven products, improving the current algorithms and gaining insights from data sets. He also takes part in client engagement meetings, plays a role in organising the analysts' team and supervises and mentors junior analysts. He works daily with data engineers, front-end developers and product managers. The high demands of his position have exposed him to a broad set of problems and situations that he has been able to solve through reasoning, research, pragmatism and hard work. The area of his job that he is most appreciative of is finding and designing solutions that bring insights from data and are useful to make informed decisions in the world.

[One-page CV](/Files/Victor J. Sequi C.V.)

## Time line

Start – Finish | Position | Department | Institution
--- | --- | --- | --- 
April 2021 – Present | Senior Transport Data Analyst| Development and Research | Citi Logik (Leeds)
...
This product included a machine learning forecasting model that Victor developed. It was trained using MND traffic as input and the known utilisation as a target. This was one of the top-selling products CL offered.
...
Victor conducted research to develop a methodology to provide detailed traversing trip insights. The methodology was based on using MND observed traces and road link network analysis to derive traversing traffic charactersitics for each main-road road link in the UK.

#### Conventional Transport Projects
Victor took part in the delivery of trip demand matrices for conventional transport planning projects where an area was defined and people-trip-OD matrices with purpose, mode and time-period were calculated for use in demand modelling.

**Tools**
#### Expansion, From Device to Population
A break through development was made by Victor when he re-invented the expansion methodology. The new methodology improved the reliability, reproducibility and speed of the expansion process while making it completely hands-off. This made all the other projects feasible from a technical and business perspective.
...
The new products required a hands-off zone system creation tool that would create an ad hoc geographical zone system for any point of interest in the UK. Victor successfully undertook the task of coding such tool in Python.
